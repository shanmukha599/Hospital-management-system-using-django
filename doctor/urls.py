...
urlpatterns = [
    ...
    path("cancel_appointment/<appointment_id>/",views.complete_appointment,name="complete_appointment"),
    ...
    path("edit_medical_report/<appointment_id>/<lab_test_id>/",views.edit_lab_test,name="add_lab_test"),
