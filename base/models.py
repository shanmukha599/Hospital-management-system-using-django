...
class MedicalRecord(models.Model):
    ...
    def __str__(self):
        ...
        return "Medical Record (No Patient)"
...
class Prescription(models.Model):
    ...
    def __str__(self):
        ...
        return "Prescription (No Patient)"
    
class Billing(models.Model):
    patient = models.ForeignKey(patient_models.Patient, on_delete= models.SET_NULL, null = True)
    appointment = models.ForeignKey(Appointment, on_delete= models.CASCADE, related_name="billings", blank = True, null = True)
    sub_total= models.DecimalField(max_digits=10, decimal_places=2)
    tax = models.DecimalField(max_digits=10, decimal_places=2)
    total = models.DecimalField(max_digits=10,decimal_places=2)
    status = models.CharField(max_length=120, choices=[('Paid','Paid'),('Unpaid','Unpaid')], default="Scheduled")
