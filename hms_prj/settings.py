...
SECRET_KEY = 'django-insecure-^!(y9*e15f-8cnb834543*ezhgtv&d6z-w+ej!bqsdbvxg1c(w'
...
JAZZMIN_SETTINGS = {
    ...
    # Icons (VERY IMPORTANT for good UI 🔥)
    "icons": {
    ...
    # UI Theme
    "theme": "flatly",          # clean UI
    "dark_mode_theme": "darkly",

    # Order apps
    "order_with_respect_to": ["doctor", "patient", "userauths"],
